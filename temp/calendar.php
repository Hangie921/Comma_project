...
<head>
	...
	<!--<script src="js/calendar-site.js"></script>-->
	...
	<div class="mainarea">
        ...
        <div class="EPcontainer">
			<div class="empty-place">
				...
				<div class="where">
					<ul class="row">
						<a href="space01.php?siteNo=7"><li class="order-place">洞庭湖</li></a>
						<a href="space01.php?siteNo=8"><li class="order-place">目黑場</li></a>
						<a href="space01.php?siteNo=3"><li class="order-place">天龍國</li></a>
						<a href="space01.php?siteNo=2"><li class="order-place">紅磨坊</li></a>
						<a href="space01.php?siteNo=5"><li class="order-place">木心坊</li></a>
						<a href="space01.php?siteNo=10"><li class="order-place">任意門</li></a>
						<a href="space01.php?siteNo=1"><li class="order-place">荒野屋</li></a>
						<a href="space01.php?siteNo=4"><li class="order-place">影知森</li></a>
						<a href="space01.php?siteNo=9"><li class="order-place">易牙居</li></a>
						<a href="space01.php?siteNo=6"><li class="order-place">金澤寧</li></a>
					</ul>
