...
<head>
	...
	<link rel="stylesheet" href="css/header-phone.css" media="screen and (min-width:0px) and (max-width:480px)">
...
<body >
	...
	<header id="header_nav">
        ...
        <div class="header">
            <div class="logo">
                <a href="index_front.php"><img src="img/LOGO-white.png" width="90" height="70"></a>
            </div>
            <div class="menu-container">
                <a href="exhibitions.php"><div class="menu">展覽資訊</div></a>
                <a href="SiteCategory.php"><div class="menu">場地種類</div></a>
                <a href="calendar.php"><div class="menu">瀏覽檔期</div></a>
                <a href="qa.php"><div class="menu">Q&A</div></a>
            </div>
             <?php require_once("membersing.php"); ?> 
            <!-- <div class="login">
            	<img src="img/singup.jpg" height="50" width="50">
                <br/><span class="signup"><a href="memberArea.html">登入 / 註冊</a></span>
                </div> -->
    ...
    <div class="bg">
    	...
    	<footer id="show_menu_container">
				<div id="pic_menu_container">
					...
					<ul id="menu_ul">
						...
						<img src="img/site/view2.jpg" alt="">
						</li>
		...
		<rect id="site_img_svg1" x="1" y="1"  stroke-miterlimit="10" /></svg>	
					...
					<!-- <a href="space01.html"> --><img src="img/site/photo006.jpg" alt=""><!-- </a> -->
				</div>
				...
				<div class="site_week" id="site_week11">
					...
					<h3>2015</h3>
					<p><span class="tens">1<br>0<br>0<br>1<br>0</span><span class="ones">1<br>4<br>6<br>5<br>4</span></p><span style="clear:both;"></span>
					<div class="svg_wrapper">
		...
		<rect id="week_svg1" x="3" y="3"  stroke-miterlimit="10" width="494" height="94"/></svg>	
					...
					<div class="week_container">
						...
						<li>
							<ul>
								<li class="day delete">15</li><li class="day delete">16</li><li class="day yellow">17</li><li class="day yellow">18</li><li class="day yellow">19</li><li class="day yellow">20</li><li class="day yellow">21</li>
							</ul>
						</li>
					</ul>
					</div>
			...
			<div class="site_box" id="site2">
				<div class="siteImgs" id="siteImg2">
					...
					<a href="space01.php"><img src="img/site/stringio5(smaill.jpg"  alt=""></a>
				</div>
				...
				<div class="site_week" id="site_week12">
					...
					<h3>2015</h3>
					<p><span class="tens">1<br>0<br>1<br>0<br>1</span><span class="ones">2<br>4<br>6<br>5<br>4</span></p><span style="clear:both;"></span>
					<div class="svg_wrapper">
		...
		<rect id="week_svg1" x="3" y="3"  stroke-miterlimit="10" width="494" height="94"/></svg>	
					...
					<div class="week_container">
						...
						<li>
							<ul>
								<li class="day delete">13</li>
								<li class="day delete">14</li>
								<li class="day yellow">15</li>
								<li class="day yellow">16</li>
								<li class="day yellow">17</li>
								<li class="day yellow">18</li>
								<li class="day yellow">19</li>
							</ul>	
						</li>
					</ul>
    ...
    <div class="con-container">
        <p>
	        <span class="footer_comma">
	        	<img src="img/footer_comma.jpg" height="10" width="10">
	        </span>
	        <span class="con1" id="tel">
	        	電話
	        </span>──────<span class="con2" id="telnum">(03)3478-189</span>
        </p>
        ...
        <p>
	        ...
	        <span class="con1" id="fax">傳真</span>──────<span class="con2" id="faxnum">(03)3478-189</span>
        ...
        <p>	
        	...
        	<span class="con1" id="mail">信箱</span>──────<span class="con2" id="emailnum">couldbedon@gmail.com</span>
        </p>
    </div>
...
<script>
	...
	// ==以下為展覽的左右移動==	
		...
		// var barCounter=0;
		// var left="",right="";
		// // $('#header_nav').animate({'top':'0px'},3500,'easeOutBounce');
		// $('#logo').animate({'opacity':'1'},5000);
		...
		// 	if(barCounter!=4){
		// 		barCounter++;
		// 		left = "-"+barCounter*101.49+"%";
		// 	$('#timeBar').animate({'left':left},1000);
		// 	$('#ex_box').animate({'left':left},1000);
		// 	}
		// });
		...
		// 	if(barCounter>1){
		// 		barCounter--;
		// 	var right = "-"+barCounter*101.49+"%";
		// 	$('#timeBar').animate({'left':right},1000);
		// 	$('#ex_box').animate({'left':right},1000);
		// 	}else{
		// 	$('#timeBar').animate({'left':'-14%'},1000);
		// 	$('#ex_box').animate({'left':'-14%'},1000);
		// 	}
		// });//end of the L click

	}else{
		$('#arrowL').click(function(){
			$('#timeBar').animate({'left':'10px'},1000);
			$('#ex_box').animate({'left':'10px'},1000);
		});
